...
const ALL_TOOLS = [
  ...
  },
  {
    id: 'photo_import',
    icon: '📷',
    title: 'QField Photo Import',
    description: 'Import photos and GPS waypoints from a field session — uploads to Supabase Storage and queues photos for Stone QA',
    status: 'active',
    roles: ['admin'],
  },
  {
    id: 'gps_import',
    icon: '📍',
    title: 'GPS Import (waypoints only)',
    description: 'Update stone GPS coordinates from a QField export without photos — use QField Photo Import for sessions with photos',
    status: 'active',
    roles: ['admin'],
  },
  {
    id: 'stone_qa',
    icon: '🔎',
    title: 'Stone Photo QA',
    description: 'Desktop queue — run Gemini on field photos, confirm extracted names and dates, match to person records',
    status: 'active',
    roles: ['admin', 'researcher'],
  },
  {
